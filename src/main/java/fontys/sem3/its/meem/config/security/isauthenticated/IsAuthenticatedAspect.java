package fontys.sem3.its.meem.config.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(fontys.sem3.its.meem.config.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(fontys.sem3.its.meem.config.security.isauthenticated.IsAuthenticated)")
